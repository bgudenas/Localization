...
---
#Prediction of LncRNA Subcellular Localization with Deep Learning from Sequence
...
source("./src/DeepLocal.R")
trans = Gene2Transcript(known$ID)

transM = Gene2Transcript(known$ID[known$Species == "Mouse"], martID = "mmusculus_gene_ensembl")
seqM = GetSeq(transM$ensembl_transcript_id, martID = "mmusculus_gene_ensembl")
...
seqs = GetSeq(trans$ensembl_transcript_id)
